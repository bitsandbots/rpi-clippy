/**
 * sproutApi.tsx — compatibility shim.
 *
...
export interface SproutElectronAi {
...
export const sproutApi: SproutApi = {
...
export const electronAi: SproutElectronAi = {
  create: llmCreate,
  destroy: llmDestroy,
