...
- **Character system**: Characters are registered in `src/renderer/character-animations.tsx`. The default is Clippy; Sprout (a hydroMazing garden-themed recolor) is included. Users can switch characters in Settings → Appearance. Sprout assets are generated by `python3 tools/generate-sprout-assets.py`.
